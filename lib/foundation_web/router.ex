defmodule FoundationWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {FoundationWeb.Layouts, :root}
  ...
  scope "/", FoundationWeb do
    ...
    ash_authentication_live_session :authenticated_routes do
      ...
      # on_mount {FoundationWeb.LiveUserAuth, :live_user_optional}
      #
      # If an authenticated user must *not* be present:
      # on_mount {FoundationWeb.LiveUserAuth, :live_no_user}
    end
  end
  ...
  scope "/", FoundationWeb do
    ...
    confirm_route Foundation.Accounts.User, :confirm_new_user,
      auth_routes_prefix: "/auth",
      overrides: [FoundationWeb.AuthOverrides, AshAuthentication.Phoenix.Overrides.Default]

    # Remove this if you do not use the magic link strategy.
    magic_sign_in_route(Foundation.Accounts.User, :magic_link,
      auth_routes_prefix: "/auth",
      overrides: [FoundationWeb.AuthOverrides, AshAuthentication.Phoenix.Overrides.Default]
    )
  end
