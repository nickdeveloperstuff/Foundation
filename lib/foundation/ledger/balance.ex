defmodule Foundation.Ledger.Balance do
  use Ash.Resource,
  ...
  balance do
    transfer_resource Foundation.Ledger.Transfer
  ...
  relationships do
    belongs_to :transfer, Foundation.Ledger.Transfer do
      attribute_type AshDoubleEntry.ULID
      allow_nil? false
      attribute_writable? true
    end

    belongs_to :account, Foundation.Ledger.Account do
      allow_nil? false
      attribute_writable? true
    end
  end
